...
#logo
photo=PhotoImage(file="photos/Record.png")
...
#button
record=Button(root,font="arial 20",text="Record",bg="#111",fg="white",border=0,command=Record).pack(pady=25)
